            ...
            <h2 className="section-header">Projects</h2>
                ...
                <section className="lazy-load" lang="en">
                    <div className="card-grid">
                        <article className="interactive-card" style={{ '--angle': '360deg' }}><h3 className="interactive-card-heading">SEO & Analytics Dashboard</h3><div className="card-meta">React, Google Search Console API, Data Visualization</div><p className="card-description">Advanced custom dashboard that combines Google Search Console data with other key sources. It visualizes relevant SEO metrics in a unified interface, providing in-depth performance tracking and actionable data-driven insights.</p><div className="card-footer"><a href="https://analytics-dashboard-two-sigma.vercel.app/" target="_blank" rel="noopener noreferrer" className="card-link"><i className="fas fa-bolt"></i> View Live Project</a></div></article>
