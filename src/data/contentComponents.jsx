        ...
        <section id="skills" className="section" lang="en">
            <h2 className="section-header">Skills</h2>
                ...
                <article className="content-box lazy-load" lang="en">
                    ...
                    <div className="skill-category-foldable" tabIndex="0">
                        <h3 className="skill-category-title" id="marketing-seo-heading" aria-expanded="false" aria-controls="marketing-seo-grid"><span>Marketing & SEO</span><i className="fas fa-chevron-down category-chevron"></i></h3>
                    ...
                    <div className="skill-category-foldable" tabIndex="0">
                        <h3 className="skill-category-title" id="core-tech-heading" aria-expanded="false" aria-controls="core-tech-grid"><span>Core Technologies</span><i className="fas fa-chevron-down category-chevron"></i></h3>
                    ...
                    <div className="skill-category-foldable" tabIndex="0">
                        <h3 className="skill-category-title" id="pm-design-heading" aria-expanded="false" aria-controls="pm-design-grid"><span>Project Management & Design</span><i className="fas fa-chevron-down category-chevron"></i></h3>
                    ...
                    <div className="skill-category-foldable" tabIndex="0">
                        <h3 className="skill-category-title" id="biz-analysis-heading" aria-expanded="false" aria-controls="biz-analysis-grid"><span>Business & Analysis</span><i className="fas fa-chevron-down category-chevron"></i></h3>
